 ...
 * @property clientMutationId The Client Mutation ID
 * @property name The name of the user to create
 * @property email The email address of the user to create
 */
data class UserInput @JsonCreator constructor(@JsonProperty("clientMutationId") val clientMutationId: String,
